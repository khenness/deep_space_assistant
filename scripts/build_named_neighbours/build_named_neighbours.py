...
Named systems with no named neighbours within 50ly (e.g. Sagittarius A* at the
galactic core) are handled at query time by the live progressive-radius fallback
in search.py — no precomputation needed for those cases.
